...
*/
Console.Clear();
Console.WriteLine("Эта программа принимает на вход любое целое число от -2147483648 до 2147483648 и выводит третью цифру слева и справа, если такие присутствуют");
